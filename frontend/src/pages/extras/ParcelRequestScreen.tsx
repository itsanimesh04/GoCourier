...
export function ParcelRequestScreen() {
  ...
  return <AppShell bottomNav={<BottomNav cartCount={cartCount} />} className="px-0" contentClassName="content-rail py-4"><ScreenHeader title="Parcel pickup & drop" /><form onSubmit={submit} className="mx-auto max-w-2xl space-y-5"><div><h1 className="font-display text-2xl font-bold">Request a parcel quote</h1><p className="mt-1 text-sm text-muted">Campus deliveries join the scheduled batch after quote acceptance.</p></div>
